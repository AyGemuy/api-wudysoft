...
class StickerLy {
  ...
  async execute(key, userParams = {}) {
    ...
    if (!config) {
      const msg = `Endpoint key '${key}' tidak terdaftar pada konfigurasi endpoint.`;
  ...
  async ai_play(p) {
    return await this.execute("ai_play", p);
  }
  async user_oid(p) {
  ...
  async feeds(p) {
    return await this.execute("feeds", p);
  }
  async pack_smart(p) {
    return await this.execute("pack_smart", p);
  }
  async banner(p) {
    return await this.execute("banner", p);
  }
  async pack_det(p) {
  ...
  async user_rec(p) {
    return await this.execute("user_rec", p);
  }
  async stick_rec(p) {
    return await this.execute("stick_rec", p);
  }
  async pack_pers(p) {
  ...
  async home(p) {
    return await this.execute("home", p);
  }
  async tab_sticks(p) {
  ...
  async tag_rec(p) {
    return await this.execute("tag_rec", p);
  }
}
export default async function handler(req, res) {
  try {
    ...
    const validActions = Object.keys(api.endpoint || {});
    if (!action) {
