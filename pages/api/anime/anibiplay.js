  ...
  if (!action) {
    return res.status(400).json({
      ...
      result: {
        ...
        usage: {
          method: "GET / POST",
          examples: ["/api/anibiplay?action=quick_search&query=One", "/api/anibiplay?action=anime_list&page=1&query=One", "/api/anibiplay?action=anime_detail&slug=shimoneta-to-iu-gainen-ga-sonzai-shinai-taikutsu-na-sekai", "/api/anibiplay?action=anime_stream&slug=shimoneta-to-iu-gainen-ga-sonzai-shinai-taikutsu-na-sekai&episode=1", "/api/anibiplay?action=manga_list&page=1&query=Shi", "/api/anibiplay?action=manga_detail&slug=shijou-saikyou-no-mahou-kenshi-f-rank-boukensha-ni-tensei-surushijou-saikyou-no-mahou-kenshi-f-rank-boukensha-ni-tensei-suru", "/api/anibiplay?action=manga_read&slug=shijou-saikyou-no-mahou-kenshi-f-rank-boukensha-ni-tensei-surushijou-saikyou-no-mahou-kenshi-f-rank-boukensha-ni-tensei-suru&chapter=148", "/api/anibiplay?action=novel_list&page=1&query=Bin", "/api/anibiplay?action=novel_detail&slug=master-pedang-dengan-bintang", "/api/anibiplay?action=novel_read&slug=master-pedang-dengan-bintang&chapter=chapter-281"]
        }
      }
    });
  }
